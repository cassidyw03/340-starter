-- SQL to create the PostgreSQL Type
...
-- Table structure for our inventory table
...
-- Table structure for our account table
...
-- Creating data for classification table
...
-- Creating data for inventory table
